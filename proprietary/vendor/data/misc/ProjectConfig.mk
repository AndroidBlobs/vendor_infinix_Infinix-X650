...
BUILD_PRELOADER = yes
BUILD_UBOOT = no
#BSP: add project && bom macro by wanghanfeng 20190422 start
CUSTOM_BUILD_VERNO = CY-X650-H8029-A
#BSP: add project && bom macro by wanghanfeng 20190422 end
#BSP: add XLYYGHBLEB-1 by ka.fang 20190520 start
CUSTOM_CONFIG_MAX_DRAM_SIZE = 0x80000000
#BSP: add XLYYGHBLEB-1 by ka.fang 20190520 end
...
CUSTOM_HAL_CAM_CAL = gc8034_otp dummy_eeprom
...
CUSTOM_HAL_IMGSENSOR = gc8034main_mipi_raw gc8034_mipi_raw gc8034mainpblc_mipi_raw gc8034pblc_mipi_raw
CUSTOM_HAL_LENS = dw9714af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = dw9718saf
CUSTOM_HAL_MAIN_IMGSENSOR = gc8034main_mipi_raw gc8034mainpblc_mipi_raw
CUSTOM_HAL_MAIN_LENS = dw9714af
#ITD:modify by camera driver team end
#BSP:modify XLWLHBLEJ-12 by zhigang.yang 20190510 start
CUSTOM_HAL_MSENSORLIB =memsic
#BSP:modify XLWLHBLEJ-12 by zhigang.yang 20190510 end
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_BACKUP_LENS = dummy_lens
CUSTOM_HAL_SUB_IMGSENSOR = gc8034_mipi_raw gc8034pblc_mipi_raw
...
#BSP:modify XLWLHBLEJ-10 by zhigang.yang 20190510 start
#BSP:modify XLWLHBLEJ-40 by zhigang.yang 20190522 start
CUSTOM_KERNEL_GYROSCOPE = yes
#BSP:modify XLWLHBLEJ-40 by zhigang.yang 20190522 end
#BSP:modify XLWLHBLEJ-10 by zhigang.yang 20190510 end
CUSTOM_KERNEL_HDMI =
CUSTOM_KERNEL_HEADSET = accdet
#ITD:modify by camera driver team start
CUSTOM_KERNEL_IMGSENSOR = gc8034main_mipi_raw gc8034_mipi_raw
#ITD:modify by camera driver team end
...
#BSP:modify XLWLHBLEJ-18 by zhigang.yang 20190514 start
CUSTOM_KERNEL_ORIENTATION_SENSOR = yes
#BSP:modify XLWLHBLEJ-18 by zhigang.yang 20190514 end
...
#TSD:Modify XLWLHBLEJ-1 by zhiqing.deng for modem p1 20190422 start
CUSTOM_MODEM = x650_h8029_a1_go
#TSD:Modify XLWLHBLEJ-1 by zhiqing.deng for modem p1 20190422 end
...
LCM_HEIGHT = 1600
LCM_WIDTH = 720
#BSP:add XLWLHBLEJ-2 by chenglong.jiang 20190425 start
TRAN_LCM_SUPPORT = yes
#BSP:add XLWLHBLEJ-2 by chenglong.jiang 20190425 end
...
MTK_BUILD_VERNO=X650-H8029AB-OGo-190815V214
MTK_BWC_SUPPORT = yes
MTK_C2K_LTE_MODE = 0
...
MTK_CAMERA_APP = no
#CameraAP:add by qizhe.feng 2019-05-27 start
MTK_CAMERA_APP_VERSION = 2
ARCSOFT_BURST_SUPPORT = yes
RLK_PORTRAIT_MODE_SUPPORT = yes
RLK_CAMERA_QUICKCAPTURE = yes
TRAN_POSTVIEW_SUPPORT = yes
#CameraAP:add by qizhe.feng 2019-05-27  end
...
# BSP:Modify XLWLHBLEJ-14 by fengshan.wang 20190510 start
MTK_FACTORY_MODE_IN_GB2312 = no
# BSP:Modify XLWLHBLEJ-14 by fengshan.wang 20190510 end
...
#SID:add XLWLHBLEJ-57 by gege.huang 20190530 start
MTK_FILEMANAGER_APP = no
#SID:add XLWLHBLEJ-57 by gege.huang 20190530 end
...
#PPD: add by qianwen.guo for Go config 20190521 start
MTK_GMO_RAM_OPTIMIZE = yes
MTK_GMO_ROM_OPTIMIZE = yes
#PPD: add by qianwen.guo for Go config 20190521 end
...
#SID:modify XLWLHBLEJ-98 by weike.xu 20190610 start
MTK_LIVEWALLPAPER_APP = no
#SID:modify XLWLHBLEJ-98 by weike.xu 20190610 end
MTK_LOADER_BACKUP = yes
MTK_LOG2SERVER_APP = no
MTK_LOG2SERVER_INTERNAL = no
#SID:add XLWLHBLEJ-46 by weike.xu 20190528 start
MTK_LOG_CUSTOMER_SUPPORT = yes
#SID:add XLWLHBLEJ-46 by weike.xu 20190528 end
...
#BSP:modify XLELHLES-7 by shentao.yang 20190508 start
#BSP:modify XLELHLES-7 by shentao.yang 20190508 end
...
#PPD: modified ProcessManager by shaojun 20190527 start
#MTK_RUNNING_BOOSTER_DEFAULT_ON = yes
#MTK_RUNNING_BOOSTER_SUPPORT = yes
#PPD: modified ProcessManager by shaojun 20190527 end
...
#TSD:Modify XLWLHBLEJ-1 by zhiqing.deng for modem p1 20190505 start
MTK_SIM_HOT_SWAP_COMMON_SLOT = yes
#TSD:Modify XLWLHBLEJ-1 by zhiqing.deng for modem p1 20190505 end
...
MTK_TOUCH_BOOST = no
MTK_TTY_SUPPORT = yes
#BSP:modify XLWLHBLEJ-23 by yinpeng.zhang 20190516 start
MTK_UART_USB_SWITCH = yes
#BSP:modify XLWLHBLEJ-23 by yinpeng.zhang 20190516 end
MTK_UFS_BOOTING = no
MTK_UFS_OTP = no
...
#BSP:add XLWLHBLEJ-16 by yong.jiang 20190510 start
TRAN_FINGERPRINT_SUPPORT = chipone_tee sunwave_tee
#BSP:add XLWLHBLEJ-16 by yong.jiang 20190510 end
#BSP: add project && bom macro by wanghanfeng 20190422 start
RLK_PROJECT=infinix_x650
OS_PRODUCT_VERSION = XOS4.1
CUSTOM_TRAN_PROJECT=tran_x650
CUSTOM_TRAN_BOM=tran_x650_a1
#BSP: add project && bom macro by wanghanfeng 20190422 end
...
#BSP:add XLELHLES-7 by shentao.yang 20190508 start
...
#TCD:add XLWLHBLEJ-596 by weijia.huang on 2019.7.04 start
TRAN_BATTERY_LIGHT_SUPPORT=yes
#TCD:add XLWLHBLEJ-596 by weijia.huang on 2019.7.04 end
#TCD:add XLWLHBLEJ-17 by wenqiang.zhang 20190521 start
BUILD_GMS=yes
BUILD_AGO_GMS=yes
BUILD_GO_GMS = yes
TRAN_2G_AGO_SUPPORT = yes
TRAN_GMSEXPRESS_PLUS_SUPPORT = yes
TRAN_RCS_SUPPORT = yes
TRAN_RCS_GO_SUPPORT = yes
#TCD:Modify Add XLWLHBLEJ-695 by xulongyan 20190708 start
TRANSSION_CLIENT_ID = android-transsion-infinix
TRAN_OPR_PROP_MS_VALUE = android-transsion-infinix-rev1
#TCD:Modify Add XLWLHBLEJ-695 by xulongyan 20190708 end
#TCD:add XLWLHBLEJ-17 by wenqiang.zhang 20190521 end
#TCD: add XLWLHBLEJ-1079 by xulongyan 20190806 start
PRODUCT_PROPERTY_OVERRIDES += ro.product.first_api_level=27
#TCD: add XLWLHBLEJ-1079 by xulongyan 20190806 end
# BSP:Modify XLWLHBLEJ-14 by fengshan.wang 20190514 start
TRAN_FT_RESET = yes
TRAN_FT_REBOOT = yes
...
#BSP:add XLWLHBLEJ-409  by ming.chen 20190628 start
TRAN_CHARGER_LEDS_SUPPORT = yes
#BSP:add XLWLHBLEJ-409  by ming.chen 20190628 end
TRAN_SYSTEM_DEVINFO = yes
# BSP:Modify XLWLHBLEJ-14 by fengshan.wang 20190514 end

#TCD:Modify XLWLHBLEJ-22 by qi.jiang 20190516 start
...
TRAN_MIDTEST_OTG_NO_SUPPORTED = no
...
TRAN_MIDTEST_FINGER_CHIPONE_TEE = yes
TRAN_MIDTEST_FINGER_SW9362_SUPPORTED = no
#ITD:ADD CAMERA_3RD xiaoxue.cai 190528 Start
...
#ITD:ADD CAMERA_3RD xiaoxue.cai 190528 End
#*********************PPD Feature Only Start******************************#
#PPD: add ProcessManager by shaojun 20190527 start
TRAN_PROCMGR_SUPPORT=yes
TRAN_PROCMGR_MODE=deep
TRAN_LMK_BOOST_SUPPORT=yes
#PPD: add ProcessManager by shaojun 20190527 end
#PPD add by shaojun for pnp feature at 20190527 start
TRAN_PNPMGR_SUPPORT = yes
#PPD add by shaojun for pnp feature at 20190527 end
...
TRAN_MIDTEST_DUAL_CAMERA_DUMMY = yes
#TCD:Modify XLWLHBLEJ-22 by qi.jiang 20190516 end

#SID:add XLWLHBLEJ-46 by weike.xu 20190528 start
TRANSSION_PRODUCT_DEVICE = Infinix-X650
TRANSSION_PRODUCT_NAME = H8029
TRANSSION_DEVICE_NAME = Infinix HOT 8 Lite
TRANSSION_PRODUCT_MODEL = Infinix X650
TRANSSION_BRAND_NAME = Infinix
TRANSSION_PRODUCT_MANUFACTURER = INFINIX MOBILITY LIMITED
TRANSSION_PRODUCT_BOARD = Infinix-X650
FINGERPRINT_BUILD_VERNO=AB-190815V214
TRAN_ODEX_SUPPORT_LEV1 = yes
TRAN_ODEX_SUPPORT_LEV2 = yes
TRAN_COSOFTWARE_SUPPORT = yes
TRAN_COSOFTWARE_GROUP_NAME=x650_h8029_a1_go
TRAN_DISABLE_ADB_RSA_SUPPORT = no
TRAN_OS_TYPE = XOS
TRAN_OS_LITE = yes
OS_GO_SUPPORT = yes
OS_NOTCH_SUPPORT = yes
OS_WATER_DROP_SUPPORT = yes
TRAN_CHARGER_SW_OTG_SUPPORT = yes
TRAN_CHARGER_OTG_LPO_SUPPORT = yes
INF_DIRAC_SUPPORT = yes
TRAN_DIRAC_HEADPHONE_SUPPORT = yes
...
TRAN_SYS_STASL = yes
#SID:add XLWLHBLEJ-1106 by min.li 20190813 start
TRAN_BOOMPLAY_SUPPORT = no
#SID:add XLWLHBLEJ-1106 by min.li 20190813 end
TRAN_PLAMSTORE_SUPPORT = yes
TRANSSION_EAGLEEE_DELETE = no
TRAN_CHROMECUSTOMIZATION_SUPPORT = yes
TRAN_XSHARE_SUPPORT = yes
TRAN_PALMSTORE_UNINSTALL_SUPPORT = yes
THIRD_FOOVIEW_SUPPORT = no
#SID:add XLWLHBLEJ-57 by gege.huang 20190530 end

#SID:add XLWLHBLEJ-58 by min.li 20190530 start
OS_WEATHER_SUPPORT =  no
OS_MYPICTURE_SUPPORT = no
OS_SINGLE_HAND_SUPPORT = yes
#SID:add XLWLHBLEJ-58 by min.li 20190530 end

#APP:add XLWLHBLEJ-49 by mingliang.cao 20190531 start
TRAN_FACEID_SUPPORT = yes
TRAN_APP_FACE_ST = yes
#APP:add XLWLHBLEJ-49 by mingliang.cao 20190531 end
#APP: Add XLWLHBLEJ-73,XLWLHBLEJ-967 for remove UserGuide by zhaoyang.shi 2019/7/29 start
RLK_COMPASS_SUPPORT = yes
#APP: Add XLWLHBLEJ-73,XLWLHBLEJ-967 for remove UserGuide by zhaoyang.shi 2019/7/29 end

#TCD:add XLESHBLEL-628 by wenqiang.zhang 20190603 start
PRODUCT_PROPERTY_OVERRIDES += ro.logd.size=262144
#TCD:add XLESHBLEL-628 by wenqiang.zhang 20190603 end
#BSP: Add XLWLHBLEJ-14 by fengshan.wang 20190605 start
TRAN_RECOVERY_NOTCH_SUPPORT = yes
#BSP: Add XLWLHBLEJ-14 by fengshan.wang 20190605 end

#TCD:add XLWLHBLEJ-116 by wenqiang.zhang 20190613 start
TRAN_GMS_MUSIC_UNINSTALL = no
#TCD:add XLWLHBLEJ-116 by wenqiang.zhang 20190613 end

#TCD:add KCLHLYYY-3 by zixuan.lian 20190617 start
TRAN_MIDTEST_PS_CAL_SUPPORTED = yes
#TCD:add KCLHLYYY-3 by zixuan.lian 20190617 end

#SID:add XLWLHBLEJ-312 by gege.huang 20190621 start
TRAN_AHA_GO_SUPPORT = yes
TRAN_AHA_UNINSTALL_SUPPORT = yes
#SID:add XLWLHBLEJ-312 by gege.huang 20190621 end

#APP: add XLWLHBLEJ-139 by zhangxu 20190701 start
TRAN_OOBE_SCREENSHOT_NOT_SUPPORT = yes
#APP: add XLWLHBLEJ-139 by zhangxu 20190701 end

#SID:add XLWLHBLEJ-849 by jian.lu 20190723 start
TRAN_YOPARTY_SUPPORT = yes
#SID:add XLWLHBLEJ-849 by jian.lu 20190723 end

#APP: add XLWLHBLEJ-998 by hanxin.zhang 20190730 start
TRAN_COMPASS_UNINSTALL_SUPPORT = yes
#APP: add XLWLHBLEJ-998 by hanxin.zhang 20190730 end
